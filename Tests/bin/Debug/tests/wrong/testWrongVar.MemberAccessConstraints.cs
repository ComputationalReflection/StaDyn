...
namespace TestVar.Wrong.MemberAccessConstraints {
    ...
    class Test {         
        ...
        public static void wrongTestFieldAccessConstraint() {
            Class obj = new Class(3);
            string s = fieldAccess(obj); // * Error
            Test test = new Test();
            fieldAccess(test);  // * Error
        }

        public static void wrongTestMethodCallConstraint() {
            Class obj = new Class(3);
            bool n = methodInvocation(obj, "obj");
            // * The attribute is a string
            Class badObj = new Class("hello");
            methodInvocation(badObj, "bye"); // * Error
            methodInvocation(new Test(), "bye"); // * Error
            methodInvocation(obj,3); // * Error
            int b = methodInvocation(obj, "obj"); // * Error
        }
