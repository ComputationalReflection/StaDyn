...
namespace TypeSystem.Constraints {
    ...
    ///                 ret := ret := op1 [ op2 ]
    /// </summary>
    class BracketConstraint : ConstraintAdapter {
        ...
        /// </summary>
        /// <param name="firstOperand">Type of the first operand</param>
        /// <param name="secondOperand">">Type of the second operand</param>
        /// <param name="location">Location where the constraint has been generated</param>
        public BracketConstraint(TypeExpression firstOperand, TypeExpression secondOperand, Location location) : 
        ...
        /// <param name="location">Location where the constraint has been generated</param>
        private BracketConstraint(TypeExpression firstOperand, TypeExpression secondOperand, TypeVariable returnType, Location location)
        ...
        /// This parameter is a mapping between them, wher key=old and value=new</param>
        ...
        public override Constraint CloneTypeVariables(IDictionary<TypeVariable, TypeVariable> typeVariableMappings, IList<EquivalenceClass> equivalenceClasses) {
            ...
            return new BracketConstraint(newFirstOperand, newSecondOperand, newReturnType, this.Location);
        }
        #endregion
