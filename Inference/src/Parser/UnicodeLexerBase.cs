// $ANTLR 2.7.6 (2005-12-22): "UnicodeLexerBase.g" -> "UnicodeLexerBase.cs"$
	...
	public 	class UnicodeLexerBase : antlr.CharScanner	, TokenStream
	 {
		...
		public UnicodeLexerBase(Stream ins) : this(new ByteBuffer(ins))
		{
		}
		
		public UnicodeLexerBase(TextReader r) : this(new CharBuffer(r))
		{
		}
		
		public UnicodeLexerBase(InputBuffer ib)		 : this(new LexerSharedInputState(ib))
		{
		}
		
		public UnicodeLexerBase(LexerSharedInputState state) : base(state)
		{
			initialize();
		}
