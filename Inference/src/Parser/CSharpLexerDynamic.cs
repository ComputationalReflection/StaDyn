// $ANTLR 2.7.6 (2005-12-22): "expandedCSharpLexerDynamic.g" -> "CSharpLexerDynamic.cs"$
...
namespace Parser
{
	...
	public 	class CSharpLexerDynamic : antlr.CharScanner	, TokenStream
	, ICSharpLexer	 {
	...
	public bool IsCombiningCharacter(string s)
	{
		...
		public CSharpLexerDynamic(Stream ins) : this(new ByteBuffer(ins))
		{
		}
		
		public CSharpLexerDynamic(TextReader r) : this(new CharBuffer(r))
		{
		}
		
		public CSharpLexerDynamic(InputBuffer ib)		 : this(new LexerSharedInputState(ib))
		{
		}
		
		public CSharpLexerDynamic(LexerSharedInputState state) : base(state)
		{
			initialize();
		}
