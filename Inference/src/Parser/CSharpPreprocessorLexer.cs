// $ANTLR 2.7.6 (2005-12-22): "expandedCSharpPreprocessorLexer.g" -> "CSharpPreprocessorLexer.cs"$
...
namespace Parser
{
	...
	public 	class CSharpPreprocessorLexer : antlr.CharScanner	, TokenStream
	 {
	...
	public bool IsCombiningCharacter(string s)
	{
		...
		public CSharpPreprocessorLexer(Stream ins) : this(new ByteBuffer(ins))
		{
		}
		
		public CSharpPreprocessorLexer(TextReader r) : this(new CharBuffer(r))
		{
		}
		
		public CSharpPreprocessorLexer(InputBuffer ib)		 : this(new LexerSharedInputState(ib))
		{
		}
		
		public CSharpPreprocessorLexer(LexerSharedInputState state) : base(state)
		{
			initialize();
		}
...
tryAgain:
	...
	public void mPP_IDENT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	protected void mLETTER_CHARACTER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		else if ((tokenSet_12_.member(cached_LA1))) {
	...
	protected void mFORMATTING_CHARACTER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mPP_FILENAME(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = PP_FILENAME;
		...
		{    // ( ... )*
			for (;;)
			{
				if ((tokenSet_15_.member(cached_LA1)))
				{
					{
						match(tokenSet_15_);
					}
...
_loop8_breakloop:			;
	...
	public void mPP_NUMBER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = PP_NUMBER;
