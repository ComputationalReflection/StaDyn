// $ANTLR 2.7.6 (2005-12-22): "expandedCSharpLexerBase.g" -> "CSharpLexerBase.cs"$
	...
	public 	class CSharpLexerBase : antlr.CharScanner	, TokenStream
	 {
		...
		public CSharpLexerBase(Stream ins) : this(new ByteBuffer(ins))
		{
		}
		
		public CSharpLexerBase(TextReader r) : this(new CharBuffer(r))
		{
		}
		
		public CSharpLexerBase(InputBuffer ib)		 : this(new LexerSharedInputState(ib))
		{
		}
		
		public CSharpLexerBase(LexerSharedInputState state) : base(state)
		{
			initialize();
		}
	...
	protected void mLETTER_CHARACTER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		case '\u02b8':  case '\u02bb':  case '\u02bc':  case '\u02bd':
		case '\u02be':  case '\u02bf':  case '\u02c0':  case '\u02c1':
		case '\u02d0':  case '\u02d1':  case '\u02e0':  case '\u02e1':
		case '\u02e2':  case '\u02e3':  case '\u02e4':  case '\u02ee':
		case '\u037a':  case '\u0559':  case '\u0640':  case '\u06e5':
		case '\u06e6':  case '\u0e46':  case '\u0ec6':  case '\u17d7':
		case '\u1843':  case '\u3005':  case '\u3031':  case '\u3032':
		case '\u3033':  case '\u3034':  case '\u3035':  case '\u303b':
		case '\u309d':  case '\u309e':  case '\u30fc':  case '\u30fd':
		case '\u30fe':  case '\uff70':  case '\uff9e':  case '\uff9f':
		{
		...
		case '\u2181':  case '\u2182':  case '\u2183':  case '\u3007':
		case '\u3021':  case '\u3022':  case '\u3023':  case '\u3024':
		case '\u3025':  case '\u3026':  case '\u3027':  case '\u3028':
		case '\u3029':  case '\u3038':  case '\u3039':  case '\u303a':
		{
	...
	protected void mUNICODE_CLASS_Cf(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	private static long[] mk_tokenSet_1_()
	{
		...
		for (int i = 129; i<=1024; i++) { data[i]=0L; }
		return data;
	}
