...
namespace CodeGeneration
{
    class VisitorASTCloner : VisitorAdapter
    {
        ...
        public override Object Visit(MethodDefinition node, Object obj)
        {
            ...
            List<Pair<TypeExpression, TypeExpression>> previouslyUnified = new List<Pair<TypeExpression, TypeExpression>>();
            ...
            for (int i = 0; i < node.ParametersInfo.Count; i++)
            {
                ...
                {
                    TypeExpression originalArgument = args[i];
                    TypeVariable paramType = (TypeVariable)originalParamType.CloneType(typeVariableMappings);
                    EquivalenceClass eclass = new EquivalenceClass();
                    eclass.add(originalArgument, SortOfUnification.Equivalent, previouslyUnified);
                    paramType.EquivalenceClass = eclass;
        ...
        {            
            ...
            if (node.ExpressionType != null)
                clonedFieldAccessExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
        ...
        public override Object Visit(NewArrayExpression node, Object obj)
        {
            ...
            clonedNewArrayExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);            
        ...
        public override Object Visit(RelationalExpression node, Object obj)
        {
            ...
            clonedRelationalExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
        ...
        public override Object Visit(SingleIdentifierExpression node, Object obj)
        {
            ...
            if (node.ExpressionType != null)
                clonedSingleIdentifierExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
            if (node.IdSymbol != null)
            {
                Symbol originalSymbol = node.IdSymbol;
                Symbol symbol = new Symbol(originalSymbol.Name, originalSymbol.Scope,originalSymbol.SymbolType.CloneType(this.typeVariableMappings), originalSymbol.IsDynamic);
        ...
        public override Object Visit(CastExpression node, Object obj)
        {
            ...
            clonedCastExpression.CastType = node.CastType.CloneType(typeVariableMappings);
        ...
        public override Object Visit(IsExpression node, Object obj)
        {
            ...
            clonedIsExpression.TypeExpr = node.TypeExpr.CloneType(typeVariableMappings);
        ...
        public override Object Visit(NullExpression node, Object obj)
        {
            ...
            clonedNullExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
        ...
        public override Object Visit(InvocationExpression node, Object obj)
        {
            ...
            clonedInvocationExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
        ...
        public override Object Visit(BaseExpression node, Object obj)
        {
            ...
            clonedBaseExpression.ExpressionType = node.ExpressionType.CloneType(this.typeVariableMappings);
        ...
        public override Object Visit(Definition node, Object obj)
        {
            ...
            clonedDefinition.TypeExpr = node.TypeExpr.CloneType(this.typeVariableMappings);            
        ...
        public override Object Visit(IdDeclaration node, Object obj)
        {
            ...
            clonedIdDeclaration.TypeExpr = node.TypeExpr.CloneType(this.typeVariableMappings);
            Symbol originalSymbol = node.Symbol;
            Symbol symbol = new Symbol(originalSymbol.Name, originalSymbol.Scope, originalSymbol.SymbolType.CloneType(this.typeVariableMappings), originalSymbol.IsDynamic);
